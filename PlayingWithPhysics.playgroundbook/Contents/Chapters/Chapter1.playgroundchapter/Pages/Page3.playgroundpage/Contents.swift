...
/*:
 ## **Spring force**
`The spring force is the force that an elastic body returns when it's pressed or stretched.`\
 If the band of a slingshot has an high spring force, it will throw the ball with a greater force and vice versa.
 Same rules apply to the ball when it bounces on the ground
 
 **Challenge**: Change the spring force of the elements and the gravity in the scene
 
 Tap `Run My Code` to show the changes you make and enjoy the game.
*/
...
//      Declaration of Background, slingshot and projectile
        ...
        let defaultProjectileSpringiness = Settings.defaultProperty.projectileSpringiness
        let defaultSlingSpringiness = Settings.defaultProperty.slingSpringiness
        
        //#-end-hidden-code
 //#-code-completion(everything, hide)
 //#-code-completion(identifier, show, defaultSlingSpringiness, defaultProjectileSpringiness, defaultGravity, defaultProjectileMass, defaultBoxMass)
 Settings.Game.slingSpringiness = /*#-editable-code*/1.5/*#-end-editable-code*/
 Settings.Game.projectileSpringiness = /*#-editable-code*/0.5/*#-end-editable-code*/
...
//#-end-hidden-code
//#-code-completion(identifier, hide, defaultSlingSpringiness, defaultProjectileSpringiness, defaultGravity, defaultProjectileMass, defaultBoxMass)
//#-code-completion(identifier, show, crazyModeOn(), crazyModeOff())
